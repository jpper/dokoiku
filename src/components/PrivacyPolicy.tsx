...
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>
        Dokoiku ("us", "we", or "our") operates the
        https://dokoiku.genoatlas.com website (hereinafter referred to as the
        "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. The Privacy Policy for Dokoiku has been
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://dokoiku.genoatlas.com website operated by
            Dokoiku
          </p>
        </li>
        <li>
      ...
      <p>Dokoiku uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Dokoiku will take all steps reasonably necessary to ensure that your
      ...
      <p>
        Dokoiku may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Dokoiku</li>
        <li>
